...
public class LoadingScreen extends ScreenAdapter {
    ...
    */
    public void showObjects(){
        ...
        raumGame.getAssetManager().load("map.tmx", TiledMap.class);            //Loads the map
        raumGame.getAssetManager().load("RaumSprite.png", Texture.class);      //Loads Raum

        //Loads Music and SFX
        raumGame.getAssetManager().load("PunchOne.wav", Sound.class);
        raumGame.getAssetManager().load("Laser.wav", Sound.class);
        raumGame.getAssetManager().load("VsMusic.wav", Music.class);
    }
